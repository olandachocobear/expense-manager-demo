...
window.CONST = {
    ...
    PWD_LENGTH: 6,
    ALERT: {
        BURN_SUCCESS_MSG: "Voucher Anda berhasil ditukar.",
        BURN_FAILURE_MSG: "",
        INVALID_CODE_MSG: "",
        ALREADY_BURN_MSG: "",
        SYSTEM_ERROR: "Error: Kesalahan Sistem.",
        BAD_CONNECTION: "Koneksi gagal. Coba periksa koneksi Anda..",
        SESS_EXPIRED: "Session expired. Silahkan login ulang.",
        ALREADY_ENTRIED_MSG: "Voucher telah di-entry untuk transaksi ini.",
        ERROR_HEADER: "Whoops, permintaan gagal..",
